...
<html lang="pt-br">
	<head>
		...
		<title>Easy Ticket - Cadastrar administradores</title>
...
<header>
	...
	<div class="container-fluid text-center">
			<div class="numbers d-flex flex-md-row justify-container-center flex-wrap">
				<div class="rect">
					<form action="register_admin_db.php" method="post">
						...
						<input type="password" name="senha" id="senha" maxlength="50"><br><br>

						<label for="confirmar">Confirmar senha</label><br>
						<input type="password" name="confirmar" id="confirmar" maxlength="50"><br><br>										
