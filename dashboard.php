...
<head>
	...
	<main>
        <a href="evento_create.php" class="cadastro">Cadastrar eventos</a><br><br>
		<table id="tableListagem" class="table table-hover table-dark">
			...
			<tbody id="bodyTabela">
				...
				<tr>
                    ...
                    <td><?php echo $item['qtde_ingressos']; ?></td>
                    <td><?php echo $item['valor_ingresso']; ?></td>
                    <td><?php echo $item['tipo']; ?></td>
					<td>
						<a href="evento_update.php?id=<?php echo $item['id']; ?>"><img src="assets/edit.png" class="edit"></a>	
						<a href="evento_delete.php?id=<?php echo $item['id']; ?>"><img src="assets/cross-circle.png" class="exclude"></a>	
					</td>
				</tr>
				<?php
						}
